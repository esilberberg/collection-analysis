...
Date   : 2022-11-01
Purpose: Prepare Print Collection Data for Analysis
"""
import argparse
import os
import pandas as pd
...
def get_args():
    ...
    parser = argparse.ArgumentParser(
        description='Prepare Print Collection Data for Analysis',
...
def main():
    ...
    if os.path.isfile(excel_file):
        ...
        df[['Subseries', 'Class_Number']] = df['Call_Number'].str.extract('([A-Za-z]+)([0-9]+)', expand = True)
